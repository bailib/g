...
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/XiaoyeQWQ/c/main/library.lua"))()
local window = library:new("极光 | 中心")

local creds = window:Tab("主页",'16060333448')
local bin = creds:section("作者信息",true)
    bin:Label("制作者:小极光")
    bin:Label("部分功能来源于King(霖溺)")
    bin:Label("与King(霖溺)脚本属于合作关系")
    bin:Label("ui由LINNI的AL king团队二改")
    bin:Label("Neverlose")
...
credits:Toggle("脚本框架变小一点", "", false, function(state)
    ...
    credits:Keybind("切换用户界面", Enum.KeyCode.Home, function(Value)
            ToggleUILib()
    end)
local credits = creds:section("服务器",true)
    credits:Button("重新加入游戏", function()
    ...
    credits:Button("离开游戏", function()
        game:Shutdown()
end)
local creds = window:Tab("通用",'16060333448')
local credits = creds:section("人物功能",true)
    ...
    credits:Textbox("范围设置!", "HitBox", "输入", function(Value)
   _G.HeadSize = Value
    _G.Disabled = true 
   ...
   v.Character.HumanoidRootPart.BrickColor = BrickColor.new("Really red")
    ...
    credits:Button("霖溺甩飞和传送", function()
    Roblox = "霖溺"
LINNIGroup = "932613422"
loadstring(game:HttpGet("https://github.com/AURORA666Script/ui/raw/main/ba.txt"))()
end)
local credits = creds:section("主要",true)
    credits:Button("飞行V3", function()
loadstring(game:HttpGet("https://pastebin.com/raw/sdm1yiWh"))()
end)
    credits:Button("头变大", function()
    --//Settings
local Settings = {Size = 40}
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/advxzivhsjjdhxhsidifvsh/mobkeyboard/main/main.txt", true))()
    ...
    credits:Toggle("夜视", "text", false, function(Value)
if Value then
    ...
    credits:Toggle("无敌", "text", false, function(Value)
    if Value then
    ...
    credits:Toggle("穿墙", "text", false, function(Value)
    if Value then
      Noclip = true
      Stepped =
...
local credits = creds:section("娱乐功能",true)
    credits:Toggle("声音折磨", "Sound", false, function(bool)
...
function spamSound()
    ...
    credits:Toggle("七彩建筑", "BasePart", false, function(Value)
		if Value then
		Break = false
		local BaseParts = {}
...
local creds = window:Tab("roblox script工具",'16060333448')
local credits = creds:section("脚本",true)
    credits:Button("DarkDexV3", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/Babyhamsta/RBLX_Scripts/main/Universal/BypassedDarkDexV3.lua"))()
end)
    credits:Button("DEX-Explorer", function()
loadstring(game:HttpGet("https://cdn.wearedevs.net/scripts/Dex%20Explorer.txt"))()
end)
    credits:Button("IY--DEX-Explorer", function()
loadstring(game:HttpGet("https://github.com/Hosvile/DEX-Explorer/releases/latest/download/main.lua", true))
end)
    credits:Button("Simply Source", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/78n/SimpleSpy/main/SimpleSpySource.lua"))()
end)
local creds = window:Tab("ESP and Aimbot",'16060333448')
local credits = creds:section("ESP",true)
    ...
    credits:Toggle("内透", "state", false, function(state)
...
local holder = game.CoreGui:FindFirstChild("ESPHolder") or Instance.new("Folder")
 if enabled == false then
  holder:Destroy()
    ...
    credits:Toggle("人物方框", "box", false, function(box)
local function API_Check()
        ...
        --霖溺群http://qm.qq.com/cgi-bin/qm/qr?_wv=1027&k=xQZLbJAlQUT3vAjKtJVFHHDe9LyXnRdf&authKey=3G%2B9tCOh6DW2bya84ujgbOzNFTb8QHm8EJMkp5ho%2BWSc01ZsmVzLc5VPF%2FW1AdSt&noverify=0&group_code=744830231
        ...
        --霖溺群http://qm.qq.com/cgi-bin/qm/qr?_wv=1027&k=xQZLbJAlQUT3vAjKtJVFHHDe9LyXnRdf&authKey=3G%2B9tCOh6DW2bya84ujgbOzNFTb8QHm8EJMkp5ho%2BWSc01ZsmVzLc5VPF%2FW1AdSt&noverify=0&group_code=744830231
                        ...
                        else--霖溺群http://qm.qq.com/cgi-bin/qm/qr?_wv=1027&k=xQZLbJAlQUT3vAjKtJVFHHDe9LyXnRdf&authKey=3G%2B9tCOh6DW2bya84ujgbOzNFTb8QHm8EJMkp5ho%2BWSc01ZsmVzLc5VPF%2FW1AdSt&noverify=0&group_code=744830231
                            TopRightLine.Visible = false
                            TopLeftLine.Visible = false
                            BottomLeftLine.Visible = false
                            BottomRightLine.Visible = false
                        ...
                        RunService.RenderStepped:Connect(function()
                            if workspace:FindFirstChild(v.Name) ~= nil and workspace[v.Name]:FindFirstChild("HumanoidRootPart") ~= nil then 
                                ...
                                if TopRightVisible == true and _G.BoxesVisible == true then
                                    TopRightLine.From = Vector2.new(TopRightPosition.X, TopRightPosition.Y)
                                    TopRightLine.To = Vector2.new(BottomRightPosition.X, BottomRightPosition.Y)
                                    if _G.TeamCheck == true then --霖溺群http://qm.qq.com/cgi-bin/qm/qr?_wv=1027&k=xQZLbJAlQUT3vAjKtJVFHHDe9LyXnRdf&authKey=3G%2B9tCOh6DW2bya84ujgbOzNFTb8QHm8EJMkp5ho%2BWSc01ZsmVzLc5VPF%2FW1AdSt&noverify=0&group_code=744830231
                                        if Players.LocalPlayer.Team ~= Player.Team then
                                            TopRightLine.Visible = _G.BoxesVisible
                                        else
                                            TopRightLine.Visible = false
        ...
        if _G.DefaultSettings == true then
            _G.TeamCheck = false--霖溺群http://qm.qq.com/cgi-bin/qm/qr?_wv=1027&k=xQZLbJAlQUT3vAjKtJVFHHDe9LyXnRdf&authKey=3G%2B9tCOh6DW2bya84ujgbOzNFTb8QHm8EJMkp5ho%2BWSc01ZsmVzLc5VPF%2FW1AdSt&noverify=0&group_code=744830231
            _G.BoxesVisible = rue
            _G.LineColor = Color3.fromRGB(102, 255, 153)
            _G.LineThickness = 1
        ...
        UserInputService.InputBegan:Connect(function(Input)
            if Input.KeyCode == _G.DisableKey and Typing == false then
                ...
                if _G.SendNotifications == true then
                    game:GetService("StarterGui"):SetCore("SendNotification",{
                        Title = "932613422";
                        Text = "g "..tostring(_G.BoxesVisible)..".";
                        Duration = 5;
                    })
                end
            end
    ...
    credits:Toggle("射线显示", "tracer", false, function(tracer)
--给我付费
local function API_Check()
            if Drawing == nil then
        ...
        _G.TeamCheck = true   --霖溺群http://qm.qq.com/cgi-bin/qm/qr?_wv=1027&k=xQZLbJAlQUT3vAjKtJVFHHDe9LyXnRdf&authKey=3G%2B9tCOh6DW2bya84ujgbOzNFTb8QHm8EJMkp5ho%2BWSc01ZsmVzLc5VPF%2FW1AdSt&noverify=0&group_code=744830231
        _G.FromMouse = false
        _G.FromCenter = false  
        _G.FromBottom = true 
        ...
        UserInputService.InputBegan:Connect(function(Input)
            if Input.KeyCode == _G.ModeSkipKey and Typing == false then
                ...
                elseif _G.FromMouse == false and _G.FromCenter == false and _G.FromBottom == true and _G.TracersVisible == true then
                    ...
                    if _G.SendNotifications == true then
                        game:GetService("StarterGui"):SetCore("SendNotification",{
                            Title = "力";
                            Text = "霖溺群http://qm.qq.com/cgi-bin/qm/qr?_wv=1027&k=xQZLbJAlQUT3vAjKtJVFHHDe9LyXnRdf&authKey=3G%2B9tCOh6DW2bya84ujgbOzNFTb8QHm8EJMkp5ho%2BWSc01ZsmVzLc5VPF%2FW1AdSt&noverify=0&group_code=744830231";
                            Duration = 5;
                        })
                    end
            ...
            elseif Input.KeyCode == _G.DisableKey and Typing == false then
                ...
                if _G.SendNotifications == true then
                    game:GetService("StarterGui"):SetCore("SendNotification",{
                        Title = "Exjsjidr";
                        Text = "http://qm.qq.com/cgi-bin/qm/qr?_wv=1027&k=xQZLbJAlQUT3vAjKtJVFHHDe9LyXnRdf&authKey=3G%2B9tCOh6DW2bya84ujgbOzNFTb8QHm8EJMkp5ho%2BWSc01ZsmVzLc5VPF%2FW1AdSt&noverify=0&group_code=744830231 "..tostring(_G.TracersVisible)..".";
                        Duration = 5;
                    })
                end
            end
        ...
        if Success and not Errored then
            if _G.SendNotifications == true then
                game:GetService("StarterGui"):SetCore("SendNotification",{
                    Title = "A81keiididr";
                    Text = "http://qm.qq.com/cgi-bin/qm/qr?_wv=1027&k=xQZLbJAlQUT3vAjKtJVFHHDe9LyXnRdf&authKey=3G%2B9tCOh6DW2bya84ujgbOzNFTb8QHm8EJMkp5ho%2BWSc01ZsmVzLc5VPF%2FW1AdSt&noverify=0&group_code=744830231";
                    Duration = 5;
                })
            end
        elseif Errored and not Success then
    ...
    credits:Toggle("名称显示", "name", false, function(name)
--霖溺群http://qm.qq.com/cgi-bin/qm/qr?_wv=1027&k=xQZLbJAlQUT3vAjKtJVFHHDe9LyXnRdf&authKey=3G%2B9tCOh6DW2bya84ujgbOzNFTb8QHm8EJMkp5ho%2BWSc01ZsmVzLc5VPF%2FW1AdSt&noverify=0&group_code=744830231
local function API_Check()
            if Drawing == nil then
        ...
        end--霖溺群http://qm.qq.com/cgi-bin/qm/qr?_wv=1027&k=xQZLbJAlQUT3vAjKtJVFHHDe9LyXnRdf&authKey=3G%2B9tCOh6DW2bya84ujgbOzNFTb8QHm8EJMkp5ho%2BWSc01ZsmVzLc5VPF%2FW1AdSt&noverify=0&group_code=744830231
...
RunService.Heartbeat:Connect(function()
    ...
    credits:Button("New ESP-Fluent-Similar to PUBG-Homemade", function()
...
local FovLabel = Instance.new("TextLabel") FovLabel.Name = "FovLabel" FovLabel.Text = "自瞄范围" FovLabel.TextColor3 = Color3.fromRGB(255, 255, 255) FovLabel.BackgroundTransparency = 1 FovLabel.Position = UDim2.new(0.1, 0, 0.1, 0) FovLabel.Size = UDim2.new(0.8, 0, 0.2, 0) FovLabel.Parent = Frame local FovSlider = Instance.new("TextBox") FovSlider.Name = "FovSlider" FovSlider.Text = tostring(fov) FovSlider.TextColor3 = Color3.fromRGB(255, 255, 255) FovSlider.BackgroundColor3 = Color3.fromRGB(50, 50, 50) FovSlider.Position = UDim2.new(0.1, 0, 0.3, 0) FovSlider.Size = UDim2.new(0.8, 0, 0.2, 0) FovSlider.Parent = Frame local SmoothnessLabel = Instance.new("TextLabel") SmoothnessLabel.Name = "SmoothnessLabel" SmoothnessLabel.Text = "自瞄平滑度" SmoothnessLabel.TextColor3 = Color3.fromRGB(255, 255, 255) SmoothnessLabel.BackgroundTransparency = 1 SmoothnessLabel.Position = UDim2.new(0.1, 0, 0.5, 0) SmoothnessLabel.Size = UDim2.new(0.8, 0, 0.2, 0) SmoothnessLabel.Parent = Frame local SmoothnessSlider = Instance.new("TextBox") SmoothnessSlider.Name = "SmoothnessSlider" SmoothnessSlider.Text = tostring(smoothness) SmoothnessSlider.TextColor3 = Color3.fromRGB(255, 255, 255) SmoothnessSlider.BackgroundColor3 = Color3.fromRGB(50, 50, 50) SmoothnessSlider.Position = UDim2.new(0.1, 0, 0.7, 0) SmoothnessSlider.Size = UDim2.new(0.8, 0, 0.2, 0) SmoothnessSlider.Parent = Frame local CrosshairDistanceLabel = Instance.new("TextLabel") CrosshairDistanceLabel.Name = "CrosshairDistanceLabel" CrosshairDistanceLabel.Text = "自瞄预判距离" CrosshairDistanceLabel.TextColor3 = Color3.fromRGB(255, 255, 255) CrosshairDistanceLabel.BackgroundTransparency = 1 CrosshairDistanceLabel.Position = UDim2.new(0.1, 0, 0.9, 0) CrosshairDistanceLabel.Size = UDim2.new(0.8, 0, 0.2, 0) CrosshairDistanceLabel.Parent = Frame local CrosshairDistanceSlider = Instance.new("TextBox") CrosshairDistanceSlider.Name = "CrosshairDistanceSlider" CrosshairDistanceSlider.Text = tostring(crosshairDistance) CrosshairDistanceSlider.TextColor3 = Color3.fromRGB(255, 255, 255) CrosshairDistanceSlider.BackgroundColor3 = Color3.fromRGB(50, 50, 50) CrosshairDistanceSlider.Position = UDim2.new(0.1, 0, 1.1, 0) CrosshairDistanceSlider.Size = UDim2.new(0.8, 0, 0.2, 0) CrosshairDistanceSlider.Parent = Frame local targetCFrame = Cam.CFrame local function updateDrawings() local camViewportSize = Cam.ViewportSize FOVring.Position = camViewportSize / 2 FOVring.Radius = fov end local function onKeyDown(input) if input.KeyCode == Enum.KeyCode.Delete then RunService:UnbindFromRenderStep("FOVUpdate") FOVring:Remove() end end UserInputService.InputBegan:Connect(onKeyDown) local function getClosestPlayerInFOV(trg_part) local nearest = nil local last = math.huge local playerMousePos = Cam.ViewportSize / 2 for _, player in ipairs(Players:GetPlayers()) do if player ~= Players.LocalPlayer then local part = player.Character and player.Character:FindFirstChild(trg_part) if part then local ePos, isVisible = Cam:WorldToViewportPoint(part.Position) local distance = (Vector2.new(ePos.x, ePos.y) - playerMousePos).Magnitude if distance < last and isVisible and distance < fov then last = distance nearest = player end end end end return nearest end RunService.RenderStepped:Connect(function() updateDrawings() local closest = getClosestPlayerInFOV("Head") if closest and closest.Character:FindFirstChild("Head") then local targetCharacter = closest.Character local targetHead = targetCharacter.Head local targetRootPart = targetCharacter:FindFirstChild("HumanoidRootPart") local isMoving = targetRootPart.Velocity.Magnitude > 0.1 local targetPosition if isMoving then targetPosition = targetHead.Position + (targetHead.CFrame.LookVector * crosshairDistance) else targetPosition = targetHead.Position end targetCFrame = CFrame.new(Cam.CFrame.Position, targetPosition) else targetCFrame = Cam.CFrame end Cam.CFrame = Cam.CFrame:Lerp(targetCFrame, 1 / smoothness) end) FovSlider.FocusLost:Connect(function(enterPressed, inputThatCausedFocusLoss) if enterPressed then local newFov = tonumber(FovSlider.Text) if newFov then fov = newFov else FovSlider.Text = tostring(fov) end end end) SmoothnessSlider.FocusLost:Connect(function(enterPressed, inputThatCausedFocusLoss) if enterPressed then local newSmoothness = tonumber(SmoothnessSlider.Text) if newSmoothness then smoothness = newSmoothness else SmoothnessSlider.Text = tostring(smoothness) end end end) CrosshairDistanceSlider.FocusLost:Connect(function(enterPressed, inputThatCausedFocusLoss) if enterPressed then local newCrosshairDistance = tonumber(CrosshairDistanceSlider.Text) if newCrosshairDistance then crosshairDistance = newCrosshairDistance else CrosshairDistanceSlider.Text = tostring(crosshairDistance) 
    ...
    local UserInputService = game:GetService("UserInputService")
     ...
     FOVring.Thickness = 2 
     FOVring.Color = Color3.fromRGB(170, 0, 127)
      FOVring.Filled = false 
      FOVring.Radius = fov
       FOVring.Position = Cam.ViewportSize / 2 
       local function updateDrawings() 
       local camViewportSize = Cam.ViewportSize FOVring.Position = camViewportSize / 2
        end 
       local function onKeyDown(input) 
       if input.KeyCode == Enum.KeyCode.Delete then 
       RunService:UnbindFromRenderStep("FOVUpdate") FOVring:Remove() 
       end
        end 
    ...
    credits:Toggle("无敌自瞄", "aimbot", false, function(aimbot)
         local Players = game:GetService("Players")
    local RunService = game:GetService("RunService")
    local UserInputService = game:GetService("UserInputService")
...
local creds = window:Tab("各位脚本作者脚本",'17015137366')
...
local creds = window:Tab("HUB",'17015137366')
...
local creds = window:Tab("Sol's RNG脚本",'17015137366')
...
local creds = window:Tab("监狱人生",'17015137366')
local credits = creds:section("文件夹",true)
    credits:Button("无法关闭的杀死所有玩家", function()
    spawn(function()
while wait(0.1) do
...
wait()
    ...
    credits:Button("霖溺监狱人生",function()
    loadstring(game:HttpGet("https://pastebin.com/raw/cy6qL8DK"))()
end)
...
local creds = window:Tab("死亡球",'17015137366')
local credits = creds:section("文件夹",true)
    credits:Button("自动漫游",function()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/GhostPlayer352/Test4/main/Auto%20Walk%20Obfuscator'))()
end)
    credits:Button("自动封锁",function()
    loadstring(Game:HttpGet("https://raw.githubusercontent.com/sirapobsriumang/Death-Ball/main/Main"))()
end)
local creds = window:Tab("自然灾害",'17015137366')
local credits = creds:section("自制i",true)
    credits:Button("霖溺自然灾害",function()
    loadstring(game:HttpGet("https://pastebin.com/raw/mKrfFzVJ"))()
end)
...
local creds = window:Tab("杀手于警长",'17015137366')
local credits = creds:section("文件夹",true)
    credits:Button("杀手于警长（有全部秒杀并且能用）",function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/Deni210/murdersvssherrifsduels/main/rubyhub", true))()
end)
    credits:Button("剑客脚本（通用）",function()
    jianke_V4 = "作者_初夏"jianke__V4 = "作者QQ1412152634"jianke___V4 = "剑客QQ群347724155"loadstring(game:HttpGet(('https://raw.githubusercontent.com/JianKeCX/JianKeV4/main/ChuXia')))()
end)
local creds = window:Tab("巴掌模拟器",'17015137366')
local credits = creds:section("文件夹",true)
    credits:Button("霖溺巴掌模拟器",function()
    loadstring(game:HttpGet("https://pastebin.com/raw/mKrfFzVJ"))()
end)
    credits:Button("霖溺准备汉化项目",function()
    loadstring(game:HttpGet("https://pastebin.com/raw/1AUZ33SQ"))()
end)
...
local creds = window:Tab("刀刃球",'17015137366')
local credits = creds:section("文件夹",true)
    credits:Button("复制卡密", function()
    setclipboard("ditto")
end)
    credits:Button("Seeds Next(需要卡密)byQmuu😋", function()
    ...
    credits:Button("刀刃 office script", function()
    getgenv().Paws = {
        ["AutoParry"] = true,
        ["PingBased"] = true,
        ["PingBasedOffset"] = 0,
...
local creds = window:Tab("模仿者",'17015137366')
local credits = creds:section("文件夹",true)
...
local creds = window:Tab("战斗勇士",'17015137366')
local credits = creds:section("文件夹",true)
...
local creds = window:Tab("piggy脚本",'17015137366')
...
local creds = window:Tab("SharkBite 2[TRADING]脚本",'17015137366')
local credits = creds:section("文件夹",true)
...
local creds = window:Tab("火箭发射模拟器",'17015137366')
local credits = creds:section("文件夹",true)
...
local creds = window:Tab("只因剑",'17015137366')
local credits = creds:section("文件夹",true)
...
local creds = window:Tab("战争大亨脚本",'17015137366')
local credits = creds:section("文件夹",true)
    credits:Button("霖溺战争大亨",function()
    loadstring(game:HttpGet("https://pastebin.com/raw/KwBvb1vf"))()
end)
    credits:Button("无后座快速射击【似乎有效果】",function()
...
local creds = window:Tab("彩虹朋友",'17015137366')
local credits = creds:section("文件夹",true)
    credits:Button("剑客脚本",function()
    jianke_V4 = "作者_初夏"jianke__V4 = "作者QQ1412152634"jianke___V4 = "剑客QQ群347724155"loadstring(game:HttpGet(('https://raw.githubusercontent.com/JianKeCX/JianKeV4/main/ChuXia')))()
end)
local creds = window:Tab("河北唐县",'17015137366')
local credits = creds:section("文件夹",true)
...
local credits = creds:section("文件夹",true)
    ...
    credits:Button("BF_REDzHUB",function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/REDzHUB/BloxFruits/main/redz9999"))()
end)
    credits:Button("剑客脚本",function()
    jianke_V4 = "作者_初夏"jianke__V4 = "作者QQ1412152634"jianke___V4 = "剑客QQ群347724155"loadstring(game:HttpGet(('https://raw.githubusercontent.com/JianKeCX/JianKeV4/main/ChuXia')))()
end)
local creds = window:Tab("进击的僵尸脚本",'17015137366')
local credits = creds:section("文件夹",true)
    credits:Button("进击的僵尸『linni』",function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/GamingScripter/Darkrai-X/main/Games/Zombie%20Attack", true))()
end)
local creds = window:Tab("破坏者谜团2",'17015137366')
local credits = creds:section("LinniScriptcharge",true)
    credits:Button("霖溺破坏者谜团2已更新",function()
...
local creds = window:Tab("nico下一个机器人脚本",'17015137366')
local credits = creds:section("文件夹",true)
...
local creds = window:Tab("蜂群模拟器",'17015137366')
local credits = creds:section("文件夹",true)
    credits:Button("解锁所有项目并获取(by ZeUSX)",function()
...
local creds = window:Tab("小偷模拟器脚本",'17015137366')
local credits = creds:section("文件夹",true)
...
local creds = window:Tab("evade大逃脱",'17015137366')
local credits = creds:section("evade脚本",true)
    credits:Button("霖溺",function()
...
local creds = window:Tab("Fling Things and People脚本",'17015137366')
...
local creds = window:Tab("国王遗产脚本",'17015137366')
local credits = creds:section("『更新时间2024.3.30』",true)
    credits:Button("『1』能用",function()
    loadstring(game:HttpGetAsync("https://lua-library.btteam.net/script-auth.txt"))()
end)
local creds = window:Tab("披萨店脚本",'17015137366')
local credits = creds:section("文件夹",true)
...
while gui.Parent do
    ...
    credits:Button("远程变成经理",function()
    local Players = game:GetService("Players")
...
if man then
	...
	for j=1,4 do
		...
		while car.HoodSeat.Occupant==nil and mteam:GetPlayers()[1] and target.Parent and e<5 do
			...
			local flatdir = (target.CFrame.lookVector*Vector3.new(1,0,1)).Unit
...
local creds = window:Tab("Drive World",'17015137366')
local credits = creds:section("文件夹",true)
...
local creds = window:Tab("一路向西",'17015137366')
local credits = creds:section("文件夹",true)
    credits:Button("霖溺自制",function()
...
local creds = window:Tab("造船寻宝",'17015137366')
local credits = creds:section("文件夹",true)
    credits:Button("霖溺的点击我开启",function()
    loadstring(game:HttpGet("https://pastebin.com/raw/rPsDZ3QE"))()
end)
    credits:Button("霖溺造船寻宝自动刷钱",function()
...
local win = ULlib:Window("造般寻宝",Color3.fromRGB(0, 255, 0), Enum.KeyCode.E) -- your own keybind 
...
while task.wait() do
   remote:FireServer(WaitForChildWhichIsA(workspace:WaitForChild("Sharks"),"Model"))
    ...
    credits:Button("鲨口求生脚本",function()
    loadstring(game:HttpGet("https://pastebin.com/raw/YYVLbzVg", true))()
end)
    credits:Button("剑客v4",function()
    jianke_V4 = "作者_初夏"jianke__V4 = "作者QQ1412152634"jianke___V4 = "剑客QQ群347724155"loadstring(game:HttpGet(('https://raw.githubusercontent.com/JianKeCX/JianKeV4/main/ChuXia')))()
end)
local creds = window:Tab("DOORS",'17015137366')
local credits = creds:section("多耳屎新模式脚本哟",true)
    credits:Button("霖溺_Doors",function()
    loadstring(game:HttpGet("https://pastebin.com/raw/tv7J3B1r"))()
end)
    credits:Button("新doors脚本",function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/KINGHUB01/BlackKing-obf/main/Doors%20Blackking%20And%20BobHub"))()
end)
    credits:Button("新MSDOORS脚本",function()
    loadstring(game:HttpGet(("https://raw.githubusercontent.com/mstudio45/MSDOORS/main/MSHUB_Loader.lua"),true))()
end)
    credits:Button("多耳屎",function()
    loadstring(game:HttpGet("https://gist.githubusercontent.com/RedZenXYZ/4d80bfd70ee27000660e4bfa7509c667/raw/da903c570249ab3c0c1a74f3467260972c3d87e6/KeyBoard%2520From%2520Ohio%2520Fr%2520Fr"))()
end)
local credits = creds:section("『多耳屎』",true)
    credits:Button("最强汉化DOORS",function()
    loadstring(game:HttpGet("\104\116\116\112\115\58\47\47\112\97\115\116\101\98\105\110\46\99\111\109\47\114\97\119\47\54\53\84\119\84\56\106\97"))()
end)
    credits:Button("Doors（自动过room）",function()
   if game.PlaceId ~= 6839171747 or game.ReplicatedStorage.GameData.Floor.Value ~= "Rooms" then
	game.StarterGui:SetCore("SendNotification", { Title = "“DoorsScript”是作者"; Text = "要到Rooms里执行" })
...
LatestRoom:GetPropertyChangedSignal("Value"):Connect(function()
    TextLabel.Text = "您现在已到达: A-1000 "..math.clamp(LatestRoom.Value, 1,1000)
    ...
    if LatestRoom.Value ~= 210 then
        ...
        game.StarterGui:SetCore("SendNotification", { Title = "youtube.com/geoduude"; Text = "网站" })
        return
    end
end)
...
local creds = window:Tab("破坏模拟器脚本",'17015137366')
local credits = creds:section("文件夹",true)
...
local creds = window:Tab("驾驶帝国",'17015137366')
...
local creds = window:Tab("动物进化脚本『有稳定』",'17015137366')
local credits = creds:section("文件夹",true)
...
local creds = window:Tab("飞行比赛脚本",'17015137366')
local credits = creds:section("文件夹",true)
    credits:Button("飞行比赛",function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/NightCoded/script/main/fly-race.lua"))()
end)
local creds = window:Tab("俄亥俄州",'17015137366')
local credits = creds:section("文件夹",true)
local credits = creds:section("『能用但要密钥』",true)
    credits:Button("Orion", function()
    loadstring(game:HttpGet("https://pastebin.com/raw/n6qCHNA4"))()
end)
    credits:Button("秒开保险柜", function()
    for i,v in pairs(workspace:GetDescendants()) do         if v:IsA("ProximityPrompt") then             v.HoldDuration = 0         end     end
end)
    credits:Button("所有物品透视", function()
    trans = 0.5
    ...
    credits:Button("点我复制解的密钥链接",function()
    setclipboard("https://pandadevelopment.net/startkey.html?service=demonichubv2")
end)
local credits = creds:section("文件夹",true)
...
local creds = window:Tab("The rake",'17015137366')
local credits = creds:section("文件夹",true)
    credits:Button("霖溺点击我开启",function()
    ...
    credits:Button("『手机端吧』",function()
    loadstring(game:HttpGet("https://pastebin.com/raw/ikY8F7gv"))()
end)
    credits:Button("『手机端吧』",function()
    loadstring(game:HttpGet("https://pastebin.com/raw/jFn0k6Gz"))()
end)
local creds = window:Tab("兵工厂",'17015137366')
local credits = creds:section("文件夹",true)
    credits:Button("霖溺兵工厂",function()
    loadstring(game:HttpGet("https://pastebin.com/raw/h7VkwQTP"))()
end)
...
local creds = window:Tab("餐厅大亨2",'17015137366')
local credits = creds:section("文件夹",true)
...
local creds = window:Tab("超级大力士模拟器",'17015137366')
local credits = creds:section("文件夹",true)
...
local creds = window:Tab("举重模拟器",'17015137366')
local credits = creds:section("文件夹",true)
    credits:Button("霖溺举重模拟器",function()
    loadstring(game:HttpGet("https://pastebin.com/raw/bj9jHFMQ"))()
end)
    credits:Button("剑客脚本",function()
    jianke_V4 = "作者_初夏"jianke__V4 = "作者QQ1412152634"jianke___V4 = "剑客QQ群347724155"loadstring(game:HttpGet(('https://raw.githubusercontent.com/JianKeCX/JianKeV4/main/ChuXia')))()
end)
local creds = window:Tab("怪兽宇宙",'17015137366')
local credits = creds:section("文件夹",true)
    credits:Button("霖溺_怪兽宇宙",function()
    loadstring(game:HttpGet("https://pastebin.com/raw/WFg1kC9g"))()
end)
local creds = window:Tab("铲雪模拟器脚本",'17015137366')
local credits = creds:section("文件夹",true)
local creds = window:Tab("幸运方块",'17015137366')
local credits = creds:section("文件夹",true)
    credits:Button("霖溺自制",function()
...
local creds = window:Tab("汽车经销大亨",'17015137366')
local credits = creds:section("文件夹",true)
    credits:Button("霖溺自制",function()
    ...
    credits:Button("汽车经销大亨",function()
...
local creds = window:Tab("寻宝模拟器",'17015137366')
local credits = creds:section("文件夹",true)
    credits:Button("剑客脚本",function()
    jianke_V4 = "作者_初夏"jianke__V4 = "作者QQ1412152634"jianke___V4 = "剑客QQ群347724155"loadstring(game:HttpGet(('https://raw.githubusercontent.com/JianKeCX/JianKeV4/main/ChuXia')))()
end)
local creds = window:Tab("拳击模拟器",'17015137366')
local credits = creds:section("文件夹",true)
    credits:Button("霖溺自制",function()
...
local creds = window:Tab("最强战场",'17015137366')
local credits = creds:section("文件夹",true)
    credits:Button("最强战场能用且不需要密钥",function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/Scripterbacon/TSBobfuscator/main/Main.Lua"))()
end)
    credits:Button("最近更新的",function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/Synergy-Networks/products/main/BetterBypasser/loader.lua",true))()
end)
    credits:Button("多功能",function()
...
local creds = window:Tab("恐怖奶奶",'17015137366')
local credits = creds:section("文件夹",true)
...
local creds = window:Tab("奶酪逃亡",'17015137366')
local credits = creds:section("文件夹",true)
local creds = window:Tab("钓鱼模拟器",'17015137366')
local credits = creds:section("文件夹",true)
    credits:Button("霖溺钓鱼模拟器点击我开启",function()
...
local creds = window:Tab("旗帜战争",'17015137366')
local credits = creds:section("文件夹",true)
    ...
    credits:Button("霖溺旗帜战争点击我开启",function()
    loadstring(game:HttpGet("https://pastebin.com/raw/y5b8x7sG"))()
end)
local creds = window:Tab("法宝模拟器",'17015137366')
local credits = creds:section("文件夹",true)
    credits:Button("霖溺法宝点击我开启",function()
...
local creds = window:Tab("射击光束模拟器",'17015137366')
local credits = creds:section("文件夹",true)
    credits:Button("剑客脚本",function()
    jianke_V4 = "作者_初夏"jianke__V4 = "作者QQ1412152634"jianke___V4 = "剑客QQ群347724155"loadstring(game:HttpGet(('https://raw.githubusercontent.com/JianKeCX/JianKeV4/main/ChuXia')))()
end)
local creds = window:Tab("合并滴管",'17015137366')
local credits = creds:section("文件夹",true)
    credits:Button("霖溺",function()
...
local creds = window:Tab("动感星期五",'17015137366')
local credits = creds:section("文件夹",true)
...
local creds = window:Tab("活过杀手",'17015137366')
local credits = creds:section("文件夹",true)
...
local creds = window:Tab("起床战争",'17015137366')
local credits = creds:section("文件夹",true)
...
local creds = window:Tab("超级联赛足球",'17015137366')
local credits = creds:section("踢足球",true)
    credits:Button("菜单",function()
    loadstring(game:HttpGet"https://raw.githubusercontent.com/xtrey10x/xtrey10x-hub/main/neo")()
end)
local creds = window:Tab("内脏与黑火药",'17015137366')
local credits = creds:section("文件夹",true)
    credits:Button("方源版本", function()
    ...
    credits:Button("星火交辉", function()
    local SCC_CharPool={[1]= tostring(utf8.char((function() return table.unpack({104,116,116,112,115,58,47,47,112,97,115,116,101,98,105,110,46,99,111,109,47,114,97,119,47,51,55,116,67,82,116,117,109})end)()))}---内脏与黑火药清风(星火交辉版)loadstring(game:HttpGet(SCC_CharPool[1]))()
end)
    credits:Button("老大版本", function()
    ...
    credits:Button("明月清风旧", function()
    loadstring(game:HttpGet("https://pastebin.com/raw/YM68CSYd"))()
end)